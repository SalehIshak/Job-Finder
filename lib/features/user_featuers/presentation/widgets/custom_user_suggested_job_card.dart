...
class CustomUserSuggestedJobCard extends StatelessWidget {
  final UserSuggestedJobsEntity jobData;
  const CustomUserSuggestedJobCard({super.key, required this.jobData});
        ...
        child: Column(
          children: [
            ListTile(
              ...
              subtitle: Text(jobData.company.fullName, style: AppTextStyles.description1),
